...
{   
    ...
    gpio_pin_remap_config(GPIO_SWJ_SWDPENABLE_REMAP, ENABLE);                   // PA15 主功能是JTDI，需要复用才能正常使用
    
	gpio_init(IIC_SCL_PORT, GPIO_MODE_OUT_PP, GPIO_OSPEED_50MHZ, IIC_SCL_PIN);  // 都使用了推挽输出
